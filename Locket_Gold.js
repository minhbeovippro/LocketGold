...
$httpClient.get(options, function (error, newResponse, data) {
  ...
  let jsonToUpdate = {
    ...
    request_date: "1111-01-01T01:01:01Z",
    subscriber: {
      entitlement: {},
      first_seen: "1969-01-01T01:01:01Z",
      original_application_version: "9999",
      last_seen: "1111-01-01T01:01:01Z",
      other_purchases: {},
      management_url: null,
      subscriptions: {},
      entitlements: {},
      original_purchase_date: "1111-01-01T01:01:01Z",
  ...
  for (const [entitlementId, productInfo] of Object.entries(
    ...
    for (const entitlement of entitlements) {
      jsonToUpdate.subscriber.entitlements[entitlement] = {
        purchase_date: "2025-05-25T01:01:01Z",
        original_purchase_date: "2025-05-25T01:01:01Z",
